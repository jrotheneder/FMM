...
(*Begin["`Private`"];*)
	...
	*)
	...
	FMM2DGravParticlePotentialEnergies=LibraryFunctionLoad[lib2DGrav,"FMMParticlePotentialEnergies",{{Real,1}(*positions*),{Real,1}(*charges*),Integer (*items per leaf*),Real (*eps*)},{Real,1} (*output array of sources*)];
	FMM2DGravEvaluatePotentials=LibraryFunctionLoad[lib2DGrav,"FMMEvaluatePotentials",{{Real,1}(*positions*),{Real,1}(*charges*),Integer (*items per leaf*),Real (*eps*),{Real,1}(*eval points*),"Boolean" (*tree to file?*)},{Real,1} (*output array of potentials*)];
	...
	Direct2DGravParticlePotentialEnergies=LibraryFunctionLoad[lib2DGrav,"DirectParticlePotentialEnergies",{{Real,1}(*positions*),{Real,1}(*charges*)},{Real,1} (*output array of sources*)];
	Direct2DGravEvaluatePotentials=LibraryFunctionLoad[lib2DGrav,"DirectEvaluatePotentials",{{Real,1}(*positions*),{Real,1}(*charges*),{Real,1}(*eval points*)},{Real,1} (*output array of potentials*)];
	...
	FMM3DGravParticlePotentialEnergies=LibraryFunctionLoad[lib3DGrav,"FMMParticlePotentialEnergies",{{Real,1}(*positions*),{Real,1}(*charges*),Integer (*items per leaf*),Real (*eps*)},{Real,1} (*output array of sources*)];
	FMM3DGravEvaluatePotentials=LibraryFunctionLoad[lib3DGrav,"FMMEvaluatePotentials",{{Real,1}(*positions*),{Real,1}(*charges*),Integer (*items per leaf*),Real (*eps*),{Real,1}(*eval points*),"Boolean" (*tree to file?*)},{Real,1} (*output array of potentials*)];
	...
	Direct3DGravParticlePotentialEnergies=LibraryFunctionLoad[lib3DGrav,"DirectParticlePotentialEnergies",{{Real,1}(*positions*),{Real,1}(*charges*)},{Real,1} (*output array of sources*)];
	Direct3DGravEvaluatePotentials=LibraryFunctionLoad[lib3DGrav,"DirectEvaluatePotentials",{{Real,1}(*positions*),{Real,1}(*charges*),{Real,1}(*eval points*)},{Real,1} (*output array of potentials*)];
...
FMM3DGravParticleForces::usage = "FMM3DGravParticleForces[positions = {\!\(\*SubscriptBox[\(x\), \(1\)]\),\!\(\*SubscriptBox[\(y\), \(1\)]\),\!\(\*SubscriptBox[\(z\), \(1\)]\),\!\(\*SubscriptBox[\(x\), \(2\)]\),\!\(\*SubscriptBox[\(y\), \(2\)]\),\!\(\*SubscriptBox[\(z\), \(2\)]\)...}, masses = {\!\(\*SubscriptBox[\(m\), \(1\)]\),\!\(\*SubscriptBox[\(m\), \(2\)]\),...}, items_per_leaf, acc_eps, force_smoothing_eps] computes gravitational interaction forces for a set of particles in 3D in parallel via the FMM.";
FMM3DGravParticlePotentialEnergies::usage = "FMM3DGravParticlePotentialEnergies[positions = {\!\(\*SubscriptBox[\(x\), \(1\)]\),\!\(\*SubscriptBox[\(y\), \(1\)]\),\!\(\*SubscriptBox[\(z\), \(1\)]\),\!\(\*SubscriptBox[\(x\), \(2\)]\),\!\(\*SubscriptBox[\(y\), \(2\)]\),\!\(\*SubscriptBox[\(z\), \(2\)]\)...}, masses = {\!\(\*SubscriptBox[\(m\), \(1\)]\),\!\(\*SubscriptBox[\(q\), \(2\)]\),...}, items_per_leaf, acc_eps, force_smoothing_eps] computes gravitational potential energies for a set of particles in 3D in parallel via the FMM";
FMM3DGravEvaluatePotentials::usage = "FMM3DGravEvaluatePotentials[positions = {\!\(\*SubscriptBox[\(x\), \(1\)]\),\!\(\*SubscriptBox[\(y\), \(1\)]\),\!\(\*SubscriptBox[\(z\), \(1\)]\),\!\(\*SubscriptBox[\(x\), \(2\)]\),\!\(\*SubscriptBox[\(y\), \(2\)]\),\!\(\*SubscriptBox[\(z\), \(2\)]\)...}, masses = {\!\(\*SubscriptBox[\(m\), \(1\)]\),\!\(\*SubscriptBox[\(m\), \(2\)]\),...}, items_per_leaf, acc_eps, force_smoothing_eps, eval_points = {\!\(\*SubscriptBox[\(x\), \(1\)]\),\!\(\*SubscriptBox[\(y\), \(1\)]\),\!\(\*SubscriptBox[\(x\), \(2\)]\),\!\(\*SubscriptBox[\(y\), \(2\)]\)...}, tree_to_file = True|False] computes gravitational potentials at a set of points by a set of charges in 3D in parallel via the FMM"; 

Direct3DGravParticleForces::usage = "Direct3DGravParticleForces[positions = {\!\(\*SubscriptBox[\(x\), \(1\)]\),\!\(\*SubscriptBox[\(y\), \(1\)]\),\!\(\*SubscriptBox[\(z\), \(1\)]\),\!\(\*SubscriptBox[\(x\), \(2\)]\),\!\(\*SubscriptBox[\(y\), \(2\)]\),\!\(\*SubscriptBox[\(z\), \(2\)]\)...}, masses = {\!\(\*SubscriptBox[\(m\), \(1\)]\),\!\(\*SubscriptBox[\(m\), \(2\)]\),...}, force_smoothing_eps] computes gravitational forces for a set of particles in 3D in parallel by the direct method";
...
Direct3DGravEvaluatePotentials::usage = "Direct3DGravEvaluatePotentials[positions = {\!\(\*SubscriptBox[\(x\), \(1\)]\),\!\(\*SubscriptBox[\(y\), \(1\)]\),\!\(\*SubscriptBox[\(z\), \(1\)]\),\!\(\*SubscriptBox[\(x\), \(2\)]\),\!\(\*SubscriptBox[\(y\), \(2\)]\),\!\(\*SubscriptBox[\(z\), \(2\)]\)...}, masses = {\!\(\*SubscriptBox[\(m\), \(1\)]\),\!\(\*SubscriptBox[\(m\), \(2\)]\),...}, force_smoothing_eps, eval_points = {\!\(\*SubscriptBox[\(x\), \(1\)]\),\!\(\*SubscriptBox[\(y\), \(1\)]\),\!\(\*SubscriptBox[\(x\), \(2\)]\),\!\(\*SubscriptBox[\(y\), \(2\)]\)...}] computes gravitational potentials at a set of points by a set of charges in 3D in parallel by the direct method";
